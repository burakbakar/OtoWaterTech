...
public class islemPirinc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_islem_pirinc);
    ...
    public void sonucHesapPirinc(View view){
        Intent i = new Intent(getBaseContext(), sonucPirinc.class);
